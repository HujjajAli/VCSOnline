...
<html>
<head>
<title> Add Staff :: Veterinary Clinic System</title>
	                        ...
	                        <div class="panel-body">
                            	<div class="position-center">
                            		<form class="form-horizontal" role="form">
                            			...
                            			<div class="form-group">
			                                <label for="shouse" class="col-lg-2 col-sm-2 control-label">Position</label>
			                                <div class="col-lg-4">
			                                    <input type="text" class="form-control" id="shouse" placeholder="Enter Staff Street/House#">
			                                </div>
			                                <label for="sarea" class="col-lg-2 col-sm-2 control-label">Qualification </label>
			                                <div class="col-lg-4">
			                                    <input type="text" class="form-control" id="sarea" placeholder="Enter Staff Area">
			                                </div>
                            			</div>
                            			<div class="form-group">
			                                <label for="shouse" class="col-lg-2 col-sm-2 control-label">Password</label>
			                                <div class="col-lg-4">
			                                    <input type="text" class="form-control" id="shouse" placeholder="Enter Staff Street/House#">
			                                </div>
			                                <label for="sarea" class="col-lg-2 col-sm-2 control-label">Confirm</label>
			                                <div class="col-lg-4">
			                                    <input type="text" class="form-control" id="sarea" placeholder="Enter Staff Area">
			                                </div>
                            			</div>
                            			<div class="form-group">
			                                ...
			                                <div class="col-lg-offset-2 col-lg-6">
			                                    <button type="submit" class="btn btn-info form-control">Add Staff</button>
			                                </div>
                            			</div>
                            		</form>
                            	</div>
